...
$(Document).ready(function () {
  $(".icon-menu").click(function (event) {
    ...
    $(".menu-li-invisible").toggleClass("li-active");
    $(".phone-header").toggleClass("phone-header_active");
...
document.documentElement.addEventListener("click", function (e) {
  if (!e.target.closest('.icon-menu')) {
    ...
    user_menu.classList.remove('menu_active'),
      $('.menu-li-invisible').removeClass("li-active"),
      $('.phone-header').removeClass("phone-header_active"),
      $('.header__logo').removeClass("header__logo_active"),
      $('.header__button').removeClass("header__button_active"),
